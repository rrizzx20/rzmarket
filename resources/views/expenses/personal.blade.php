<x-smoke-layout>
    <x-slot name="title">Keperluan Pribadi - SmokePOS</x-slot>

    <div class="flex-stack" style="margin-bottom: 2rem;">
        <div>
            <h2 style="font-size: 1.5rem; margin: 0; font-weight: 700;">Keperluan Pribadi</h2>
            <p style="color: var(--text-muted); margin-top: 4px; font-size: 0.8125rem;">Masukkan detail pengeluaran untuk keperluan pribadi.</p>
        </div>
    </div>
    ...
    <div style="max-width: 600px;">
        <div class="smoke-card">
            <form action="{{ route('expenses.store') }}" method="POST">
                @csrf
                <input type="hidden" name="category" value="Pribadi">
                ...
                <div style="margin-bottom: 1.5rem;">
                    <label style="display: block; margin-bottom: 0.5rem; font-size: 0.875rem;">Keterangan</label>
